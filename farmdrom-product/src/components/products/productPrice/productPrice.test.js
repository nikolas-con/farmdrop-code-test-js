...
describe('renders <ProductPrice/>', ()=>{
  it('renders the produnt does not have variants with sele', ()=>{
  ...
  it('renders the produnt has variants with sele', ()=>{
  ...
  it('renders the produnt does not have variants and has sele', ()=>{
